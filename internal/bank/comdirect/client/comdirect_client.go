...
import (
	...
	"github.com/jabbrwcky/paperless-bank/internal/bank/comdirect/client/messages"
	"github.com/jabbrwcky/paperless-bank/internal/bank/comdirect/client/session"
)

// Default comdirect HTTP client.
var Default = NewHTTPClient(nil)

const (
	// DefaultHost is the default Host found in Meta (info) section of spec file.
	DefaultHost string = "api.comdirect.de"
...
// NewHTTPClient creates a new comdirect HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Comdirect {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new comdirect HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Comdirect {
...
// New creates a new comdirect client.
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Comdirect {
	// ensure nullable parameters have default
	if formats == nil {
...
// Comdirect is a client for comdirect.
type Comdirect struct {
...
func (c *Comdirect) SetTransport(transport runtime.ContextualTransport) {
